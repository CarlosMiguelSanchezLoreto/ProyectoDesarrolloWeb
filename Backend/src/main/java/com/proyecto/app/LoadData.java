...
class LoadData {
	...
	@Bean
	CommandLineRunner llenarBD (RestauranteRepository  restauranteRepository, ReservaRepository reservaRepository, ClienteRepository clienteRepository, BCryptPasswordEncoder bCryptPasswordEncoder){
		return args ->{
...
//CLIENTES			
			...
			cliente1.setUsername("carlossloreto");
			cliente1.setPassword(bCryptPasswordEncoder.encode("12345"));
